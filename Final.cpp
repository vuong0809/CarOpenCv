...
void Stop_detection()
{
    if(!Stop_Cascade.load("//home//pi//Desktop//CarOpenCv//models//Stop_cascade.xml"))
    {
...
{
    if(!Traffic_Cascade.load("//home//pi//Desktop//CarOpenCv//models//Trafficc_cascade_1.xml"))
    {
...
{
    if(!Object_Cascade.load("//home//pi//Desktop//CarOpenCv//models//Object_cascade1.xml"))
    {
